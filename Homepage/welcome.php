...
<body id="top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" role="button" data-toggle="modal" data-target="#emailUsModal">E-mail Us</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section id="faqs" class="section">
        <div class="col-lg-12 text-center">
            <h2 class="text-black" style="font-family: 'Bebas Neue', cursive;color:white;font-size: 45px;font-weight: bold;">FREQUENTLY ASKED QUESTIONS</h2>
        </div>
        <div class="container">
            <div class="col-lg-12">
