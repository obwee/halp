...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" role="button" data-toggle="modal" data-target="#emailUsModal">E-mail Us</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <button class="btn btn-success animated fadeIn" style="animation-delay: 0.5s; background-color: #A2C710;border:none;color: white;font-weight: bold;" data-toggle="modal" data-target="#registerModal"><i class="fas fa-user-plus"></i> Register</button>
                        <button class="btn btn-warning animated fadeIn" style="animation-delay: 0.5s; color:white;font-weight: bold;"><i class="fas fa-sign-in-alt"></i> &nbspLogin&nbsp&nbsp</button>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="animated fadeIn" style="animation-delay: 0.5s">Learn. Get <span>Certified.</span></h2>
                        <h3 class="animated fadeIn" style="animation-delay: 0.5s">Advance your <span>IT</span> career with us.</h3>
                        <button class="btn btn-success animated fadeIn" style="animation-delay: 0.5s;color: white;font-weight: bold;" data-toggle="modal" data-target="#registerModal"><i class="fas fa-user-plus"></i> Register</button>
                        <button class="btn btn-warning animated fadeIn" style="animation-delay: 0.5s; color:white;font-weight: bold;"><i class="fas fa-sign-in-alt"></i> &nbspLogin&nbsp&nbsp</button>
                    </div>
                </div>
                <div class="carousel-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="text-black" style="font-family: 'Bebas Neue', cursive;font-size: 45px;font-weight: bold;">About Us</h2>
                    <hr class="light my-4">
                    ...
                    <p class="mb-4">Nexus ITTC provides IT Training and offers bootcamps for Cisco, Microsoft, VMWare, Citrix and more. Nexus trains interested students in their chosen field to learn more and experience more through the advanced and innovative teaching process with the latest devices and certified instructors.</p>
    ...
    <section id="faqs" class="section">
        <div class="col-lg-12 text-center">
            <h2 class="text-black" style="font-family: 'Bebas Neue', cursive;font-size: 45px;font-weight: bold;">FREQUENTLY ASKED QUESTIONS</h2>
        </div>
        <div class="container">
            <div class="accordion" id="accordion" style="padding:50px 50px;">
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <h2 class="mb-0">
                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="fas fa-question-circle"></i> What are the available course and schedules?</button>
                        </h2>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingTwo">
                        <h2 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><i class="fas fa-question-circle"></i> How do I request for an invoice or quotation?</button>
                        </h2>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingThree">
                        <h2 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"><i class="fas fa-question-circle"></i> How to enroll?</button>
                        </h2>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingFour">
                        <h2 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree"><i class="fas fa-question-circle"></i> What are the payment modes?</button>
                        </h2>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingFive">
                        <h2 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive"><i class="fas fa-question-circle"></i> Do you accept payment via installment basis?</button>
                        </h2>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingSix">
                        <h2 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix"><i class="fas fa-question-circle"></i> How do I pay for my reservation?</button>
                        </h2>
                    </div>
