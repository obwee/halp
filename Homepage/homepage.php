...
<head>
    ...
    <title>Nexus InfoTech Training Center</title>
...
<!-- Landing Text sa Homepage

<div id="home">
    <div class="landing-text">
        <h1>NEXUS IT TRAINING CENTER CO.</h1>
        <h3>Experience <span>IT</span>. We make <span>IT</span> happen.</h3>
        <a class="btn btn-default btn-lg" href="#">Enroll Now</a> 
    </div>  
</div> -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/Cisco_Blue.jpg" alt="Cisco">
                    </div>
                    <div class="details">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/Vmware.png" alt="Vmware">
                    </div>
                    <div class="details">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/Microsoft.jpg" alt="Microsoft">
                    </div>
                    <div class="details">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/AWS.png" alt="AWS">
                    </div>
                    <div class="details">
                        <div class="content">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/Citrix.jpg" alt="Cisco">
                    </div>
                    <div class="details">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/office365.jpg" alt="Cisco">
                    </div>
                    <div class="details">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/EthicalHacking.jpg" alt="Cisco">
                    </div>
                    <div class="details">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="box">
                    <div class="imgBox">
                        <img src="Courses/azure.png" alt="AWS">
                    </div>
                    <div class="details">
                        <div class="content">
