                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="studendUnpaid.php"><i class="fas fa-times"></i>&emsp; Unpaid Reservations</a></li>
                            <li><a href="studentPartialPayment.php"><i class="fas fa-check"></i>&emsp;Partially Paid Reservations</a></li>
                            <li><a href="studentFullPayment.php"><i class="fas fa-check-double"></i>&emsp;Fully Paid Reservations</a></li>
                        </ul>
                    </li>
                    <li>
