...
?>
	...
	<div class="container">
		...
		<div class="table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl">
			...
			<table id="tbl_schedule" style="width:100%" class="table table-striped table-bordered table-hover table-responsive-sm">
				<thead>
					<tr>
    ...
    <div class="modal fade" id="editScheduleModal" role="dialog">
        <div class="modal-dialog vertical-align-center editScheduleModal">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #A2C710;">
