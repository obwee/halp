        ...
        <div class="row">
            <div class="col-sm-6">
                <form>
                    ...
                    <label for="firstName" class="col-sm-3 col-form-label"><span class="fas fa-book"></span> Course</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label"><span class="fas fa-map"></span> Venue</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="email" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label"><span class="fas fa-chalkboard-teacher"></span> Instructor</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="email" readonly>
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                <form>
                    <div class="form-group row">
                    <label for="firstName" class="col-sm-3 col-form-label"><span class="fas fa-calendar-alt"></span> Schedule</label>
                        <div class="col-sm-9">
                            <select class="form-control">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-4 col-form-label"><span class="fas fa-users"></span> Available Slots</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="email" readonly>
                        </div>
                    </div>
			...
			<table id="tbl_enrollment" style="width:100%" class="table table-striped table-bordered table-hover table-responsive-sm">
				...
				<tbody>
                    <tr>
                        ...
                        <td>Mark Sampayan</td>
                        <td>
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#paymentModal"><i class="fas fa-hand-holding-usd"></i></button>
