var oApprovedRefunds = (() => {
    ...
    let oColumns = {
        ...
        aRequestDetails: [
            ...
            {
                title: 'Approved By', className: 'text-center', data: 'approvedBy'
            }
        ]
    };
    ...
    function setEvents() {
        ...
        $(document).on('click', '#viewDetails', function () {
            fetchTrainingDataOfSelectedStudentWithApprovedRefunds($(this).attr('data-id'));
    ...
    function fetchTrainingDataOfSelectedStudentWithApprovedRefunds(iStudentId) {
        $.ajax({
            ...
            success: function (oResponse) {
                ...
                const aData = aTrainingDetails.filter(oData => oData.refundStatus == 'Approved');
