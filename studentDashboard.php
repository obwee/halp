  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <a href="cancelledBookings.php">
      <div class="info-box">
        ...
        <div class="info-box-content" style="text-align:center;">
          <span class="info-box-text">TAE</span>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header" style="padding:10px 10px;">
        <h5 align="center"><span class="glyphicon glyphicon-plane"></span> Payment</h5>
          ...
          <table id="tbl_tours" style="width:100%" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th style="white-space:nowrap;">Student Name ID</th>
      ...
      <div class="modal-footer">
        <button type="uploadBtn" class="btn btn-primary">
...
<div class="container">
  <div class="modal fade" id="editTourModal" role="dialog" style="z-index:2000;">
    <div class="modal-dialog vertical-align-center">
      <div class="modal-content">
        <div class="modal-header" style="padding:10px 10px;">
          <h5 align="center"><span class="glyphicon glyphicon-plane"></span>Edit Enrollment Details</h5>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <form method="post" id="editTourForm" enctype="multipart/form-data">
          <div class="modal-body" style="padding:30px 50px;">
            <div class="form-group">
              <label for="tour_Destination"><span class="fas fa-globe-asia"></span> Course</label>
              <input type="text" class="form-control tour_DestinationEdit" id="tour_DestinationEdit" name="tour_DestinationEdit" placeholder="Destination" maxlength="25" autocomplete="off" required>
              <div id="destinationListEdit"></div>
            </div>
            <div class="form-group">
              <label for="tour_Destination"><span class="fas fa-globe-asia"></span> Schedule</label>
              <input type="text" class="form-control tour_DestinationEdit" id="tour_DestinationEdit" name="tour_DestinationEdit" placeholder="Destination" maxlength="25" autocomplete="off" required>
              <div id="destinationListEdit"></div>
            </div>
          </div>
      ...
      <form id="quotationImageForm" method='POST'>
        <div class="modal-body" style="padding:30px 50px;">
          <div class="fileUpload">
            <div class="form-group">
              <label for="quotationImage"><span class="fas fa-upload"></span> Download Quotation</label><br>
