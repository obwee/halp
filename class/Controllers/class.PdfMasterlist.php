...
class Pdf extends Fpdf
{
    ...
    public function Header()
    {
        ...
        // Set page header title.
        $this->Cell(35, 8, 'Master List', 0, 1, 'C');

        $this->SetFont('BebasNeue-Regular', '', 12);

        // Set Course Code
        $this->Cell(30, 5, 'COURSE CODE:', 0, 0, 'L');
        $this->SetFont('Arial', '', 9);
        $this->Cell(50, 5, '[Course Code]', 0, 0, 'L');
        ...
        $this->Cell(30, 5, 'COURSE DESCRIPTION:', 0, 0, 'L');
        $this->SetFont('Arial', '', 9);
        $this->Cell(100, 5, '[Course Description]', 0, 0, 'L');

        $this->SetFont('BebasNeue-Regular', '', 12);
        $this->Cell(8);

        // Set Schedule
        $this->Cell(20, 5, 'SCHEDULE:', 0, 0, 'L');
        $this->SetFont('Arial', '', 9);
        $this->Cell(70, 5, '[Schedule]', 0, 1, 'L');
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(70, 5, '[Instructor]', 0, 0, 'L');
        // Line break.
        $this->Ln(8);
    ...
    public function InitializePage()
    {
        ...
        //Table Content
        $this->Cell(22, 5, 'STUDENT ID', 1, 0, 'C');
